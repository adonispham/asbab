    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <section class="form-admin">
                <form id="delivery-form" data-action="{{ route('admin.delivery.store') }}" method="post" class="row flex-center">
                    @csrf
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label>Provinces:</label>
                            <select name="province_id" class="form-control" data-url="{{ route('admin.delivery.provinces') }}">
